                ...
                <div className="container-fluid contact bg-light py-5 bg-[url('assets/img/illusion.png')]">
                    ...
                    <div className="container py-5">
                        <div className="row g-5">
                            <ContactCard h1="Address" para="Sardar Patel Institute of Public Administration (SPIPA) Opp ISRO, Satellite Road, Satellite, Ahmedabad-380 015" icon={<GiWorld color="white" className="w-[100px] h-[100px]" />} />
                            ...
                            >
                                <div className="h-100 overflow-hidden rounded-5">
                                    <iframe
                                        ...
                                        marginHeight={0}
                                        marginWidth={0}
                                        src="https://www.google.com/maps/embed/v1/place?q=spipa&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"
                                    ></iframe>
                                </div>
                            </div>
                        </div>
