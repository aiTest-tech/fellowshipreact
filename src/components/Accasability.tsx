...
const Accasability = () => {
    return (
        <>
            {/* accessibility panel */}
            <div
                className="uwaw uw-light-theme gradient-head uwaw-initial paid_widget"
                id="uw-main"
            >
                {" "}
                <div className="relative second-panel">
                    ...
                    <div className="uwaw-close" onclick="closeMain()" />{" "}
                </div>{" "}
                <div className="uwaw-body">
                    ...
                    <div className="h-scroll">
                        ...
                        <div className="uwaw-features">
                            {" "}
                            <div
                                className="uwaw-features__item reset-feature"
                                id="featureItem_sp"
                            >
                                {" "}
                                <button
                            ...
                            <div className="uwaw-features__item reset-feature" id="featureItem">
                                ...
                                >
                                    ...
                                    <div
                                        className="uwaw-features__item__steps reset-steps"
                                        id="featureSteps"
                                    >
                                        {" "}
                                ...
                                >
                                    ...
                                    <span className="uwaw-features__item__name">
                                        ...
                                        <span className="light_dark_icon">
                                            ...
                                            <input
                                                type="checkbox"
                                                className="light_mode uwaw-featugres__item__i"
                                                id="checkbox"
                                            />{" "}
                                            <label htmlFor="checkbox" className="checkbox-label">
                                                ...
                                                <i className="fas fa-moon-stars">
                                                    {" "}
                                                    <span className="ux4g-icon icon-moon" />{" "}
                                                </i>{" "}
                                                <i className="fas fa-sun">
                                                    {" "}
                                                    <span className="ux4g-icon icon-sun" />{" "}
                                                </i>{" "}
                                                <span className="ball" />{" "}
                                            </label>{" "}
                                        </span>{" "}
                ...
                <div className="reset-panel">
                    ...
                    <div className="copyrights-accessibility">
                        ...
                        >
                            {" "}
                            <span className="uwaw-features__item__name ux4g-copy ux4g-copyright">
                                Created by
                            </span>{" "}
                            <img
