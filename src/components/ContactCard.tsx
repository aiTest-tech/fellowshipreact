...
// import EmailLogo from '../../public/assets/img/edpspipa@gmail.com.png'
import EmailLogo from '../assets/edpspipa@gmail.com.png'
        ...
        <div className="rounded-lg overflow-hidden shadow-lg bg-gray-50 h-[220px]">
          ...
          <div className="px-6 mt-20">
            ...
            {props.para === "edpspipa@gmail.com" ? (
              <>
                {/* <img src="public/assets/img/edpspipa@gmail.com.png" alt="" className="ml-16" /> */}
                <img src={EmailLogo} alt="" className="ml-16" />
              </>
            ) : (
              <>
