    ...
    return (
        <div className="flex justify-center items-center" onClick={onClick}>
            <div className="relative w-[250px] h-[255px] mb-8 cursor-pointer">
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[250px] h-[255px] rounded-lg overflow-hidden shadow-lg transition-transform duration-500 group">
                    <div className="relative w-full h-full">
                        <img
                            src={imageUrl}
                            alt={name}
